...
public class Persistencia {
	...
	public static ListagemModelo criarModeloInfoBanco(Connection conn) throws PersistenciaException {
		try {
	...
	public static ListagemModelo criarModeloEsquema(Connection conn) throws PersistenciaException {
		try {
			List<List<String>> dados = new ArrayList<>();
			DatabaseMetaData m = conn.getMetaData();
