...
public class ObjetoContainer extends AbstratoContainer implements PluginBasico {
	...
	private class Toolbar extends BarraButton {
		...
		private class ButtonStatus extends ButtonPopup {
			...
			private Action somObjetoSelAcao = actionMenu("label.somente_objeto_sel", Icones.RECT);
