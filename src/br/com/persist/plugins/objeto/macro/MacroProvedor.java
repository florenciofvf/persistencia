...
import br.com.persist.plugins.objeto.macro.Macro.AjusteAutoEnter;
...
public class MacroProvedor {
	...
	private static final String AJUSTE_AUTO_ENTER = "ajusteAutoEnter";
	...
	public static void ajusteAutoEnter(Object valor) {
		Instrucao instrucao = get(AJUSTE_AUTO_ENTER);
		instrucao.setValor(valor);
		adicionar(instrucao);
	}
