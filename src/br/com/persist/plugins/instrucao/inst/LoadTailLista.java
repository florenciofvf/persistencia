...
public class LoadTailLista extends Instrucao {
	private boolean parametro;
	private String param;

	public LoadTailLista(Metodo metodo) {
		super(metodo, InstrucaoConstantes.LOAD_TAIL_LISTA);
	}
	...
	public void setParam(String string) throws InstrucaoException {
		if (string == null) {
			throw new InstrucaoException("LoadTailLista param null.");
		}
		this.param = string;
	...
	public void executar(PilhaMetodo pilhaMetodo, PilhaOperando pilhaOperando, CacheBiblioteca cacheBiblioteca)
		...
		pilhaOperando.push(((Lista) valor).tail());
	}
}