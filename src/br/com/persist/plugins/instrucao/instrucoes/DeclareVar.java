...
public class DeclareVar extends Instrucao {
	private String param;

	public DeclareVar(Metodo metodo) {
		super(metodo, InstrucaoConstantes.DECLARE_VAR);
	}

	@Override
	public Instrucao clonar(Metodo metodo) {
		DeclareVar resp = new DeclareVar(metodo);
		resp.param = param;
		return resp;
	}
	...
	public void executar(PilhaMetodo pilhaMetodo, PilhaOperando pilhaOperando, CacheBiblioteca cacheBiblioteca)
		...
		biblioteca.declararVariavel(nome, valor);
	}
}